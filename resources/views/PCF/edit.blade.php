        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Edit PCF Request</h1>
                </div>
                ...
                <div class="row sticky">
                    <div class="col-md-12">
                        <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 8px;">
                            <div class="card-body">
                                <form action="{{ route('PCF.update', $pcfRequest->id) }}" method="post" id="submit_pcf_request_form">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="form-group col-md-1">
                                            ...
                                            <input type="text" class="form-control @error('pcf_no') is-invalid @enderror" name="pcf_no" id="pcf_no"
                                                value="{{ old('pcf_no', $pcfRequest->pcf_no) }}" required readonly>
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <input type="text" class="form-control @error('rfq_no') is-invalid @enderror" name="rfq_no" id="rfq_no"
                                                value="{{ old('rfq_no', $pcfRequest->rfq_no) }}" required readonly>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address" value="{{ old('address', $pcfRequest->institutions->address) }}" disabled>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control @error('contact_person') is-invalid @enderror" name="contact_person" id="contact_person"
                                                    value="{{ old('contact_person', $pcfRequest->contact_person) }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" id="designation"
                                                value="{{ old('designation', $pcfRequest->designation) }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control @error('thru_contact_person') is-invalid @enderror" name="thru_contact_person" id="thru_contact_person"
                                                value="{{ old('thru_contact_person', $pcfRequest->thru_contact_person) }}">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control @error('thru_designation') is-invalid @enderror" name="thru_designation" id="thru_designation"
                                                value="{{ old('thru_designation', $pcfRequest->thru_designation) }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('supplier') is-invalid @enderror" name="supplier" id="supplier"
                                                value="{{ old('supplier', $pcfRequest->supplier) }}" required>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('terms') is-invalid @enderror" name="terms" id="terms"
                                                value="{{ old('terms', $pcfRequest->terms) }}" required>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('validity') is-invalid @enderror" name="validity" id="validity"
                                                value="{{ old('validity', $pcfRequest->validity) }}" required>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('delivery') is-invalid @enderror" name="delivery" id="delivery"
                                                value="{{ old('delivery', $pcfRequest->delivery) }}" required>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control @error('warranty') is-invalid @enderror" name="warranty" id="warranty"
                                                value="{{ old('warranty', $pcfRequest->warranty) }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control @error('contract_duration') is-invalid @enderror" name="contract_duration" id="contract_duration"
                                                value="{{ old('contract_duration', $pcfRequest->contract_duration) }}">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input type="checkbox" id="dateBiddingCheckBox" aria-label="Checkbox for following date input" {{ (empty($pcfRequest->date_bidding) ? "checked" : "") }}>
                                                ...
                                                <input type="date" class="form-control @error('date_bidding') is-invalid @enderror" name="date_bidding" id="date_bidding"
                                                    value="{{ old('date_bidding') }}" aria-describedby="date_bidding" {{ (empty($pcfRequest->date_bidding) ? "readonly" : "") }}>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control @error('bid_docs_price') is-invalid @enderror" name="bid_docs_price" id="bid_docs_price"
                                                value="{{ old('bid_docs_price', $pcfRequest->bid_docs_price) }}" {{ (empty($pcfRequest->date_bidding) ? "readonly" : "") }}>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control @error('manager') is-invalid @enderror" name="manager" id="manager" required>
                                                ...
                                                <option value="Rachelle Anne Carrera" {{ ($pcfRequest->manager == 'Rachelle Anne Carrera' ? 'selected' : '') }}>Rachelle Anne Carrera</option>
                                                <option value="Gloria Cutang" {{ ($pcfRequest->manager == 'Gloria Cutang' ? 'selected' : '') }}>Gloria Cutang</option>
                                                <option value="Gilbert Gravata" {{ ($pcfRequest->manager == 'Gilbert Gravata' ? 'selected' : '') }}>Gilbert Gravata</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('annual_profit') is-invalid @enderror" name="annual_profit" id="annual_profit"
                                                value="{{ old('annual_profit', $pcfRequest->annual_profit) }}" readonly required> 
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('annual_profit_rate') is-invalid @enderror" name="annual_profit_rate" id="annual_profit_rate"
                                                value="{{ old('annual_profit_rate', $pcfRequest->annual_profit_rate) }}" readonly required>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        $('#pcfItem_datatable').DataTable({
            ...
            ordering: true,
            ajax: {
                url : "{{ route('PCF.sub.item_list', $pcfRequest->pcf_no) }}",
                headers: {
        ...
        $('#mandatory_peripherals_datatable').DataTable({
            ...
            ordering: true,
            ajax: {
                url : "{{ route('PCF.sub.get_pcf_list_mandatory_items', $pcfRequest->pcf_no) }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
            },
        ...
        $('#pcfFOC_dataTable').DataTable({
            ...
            ordering: true,
            ajax: {
                url : "{{ route('PCF.sub.foc_list', $pcfRequest->pcf_no) }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
            },
    ...
    function getInstitutions() {
        $.ajax({
                ...
                data = res.data;
                $("#institution").val({!! $pcfRequest->institution_id !!}).select2({
                    data: data,
                    width: "100%",
                    allowClear: true,

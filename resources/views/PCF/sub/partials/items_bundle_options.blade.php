    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">New Options</h5>
            ...
            <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="source_id" id="item_code_bundle" class="select2" required></select>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dt-responsive nowrap" id="pcfItemBundle_datatable">
                            <thead>
                                <tr>
                                    <th>Item Code</th>
